...
export const getFeaturedProducts = async (req, res) => {
  try {
    ...
    // .lean() returns a plain javascript object instead of a mongodb document which is good for perfomance
...
export const createProduct = async (req, res) => {
  try {
    ...
    console.log("Error in Create Procuct Controller", error.message);
...
async function updateFeaturedProductsCache() {
  try {
    // The lean() method is used to return plain Javascript object instead of full mongoose documents. This can significantly improve perfomance
